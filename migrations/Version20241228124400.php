 ...
 */
final class Version20241228124400 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contenu_panier ADD produit_id INT NOT NULL, ADD panier_id INT NOT NULL, ADD quantite INT NOT NULL, ADD dateajout DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contenu_panier DROP produit_id, DROP panier_id, DROP quantite, DROP dateajout');
    }
}
